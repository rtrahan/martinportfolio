...
export default function GalleryPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-stone-100 dark:bg-stone-900 text-stone-900 dark:text-stone-100">
      ...
      <main id="projects" className="flex-1 w-full max-w-6xl mx-auto px-6 py-12 md:py-16 pb-24">
      ...
      <footer className="py-8 px-6 border-t border-stone-200 dark:border-stone-800 text-center text-stone-600 dark:text-stone-500 text-sm">
